USE [master]
GO
/****** Object:  Database [Codecademy]    Script Date: 19/12/2021 14:14:22 ******/
...
USE [Codecademy]
GO
/****** Object:  Table [dbo].[Certificate]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Contact]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ContentItem]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Course]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CourseRecommendation]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Enrollment]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Module]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Organization]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Progress]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Speaker]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Student]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Webcast]    Script Date: 19/12/2021 14:14:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[ContentItem] ([ContentID], [CreationDate], [Description], [Status]) VALUES (2, CAST(N'2020-12-19' AS Date), N'A course teaching you how to connect Java to SQL Server', N'ACTIVE')
GO
...
GO
INSERT [dbo].[ContentItem] ([ContentID], [CreationDate], [Description], [Status]) VALUES (5, CAST(N'2021-06-03' AS Date), N'A course teaching you how to to write Hello World in Java', N'ACTIVE')
GO
...
GO
INSERT [dbo].[ContentItem] ([ContentID], [CreationDate], [Description], [Status]) VALUES (9, CAST(N'2020-02-29' AS Date), N'Avans intake course', N'ACTIVE')
GO
SET IDENTITY_INSERT [dbo].[ContentItem] OFF
GO
INSERT [dbo].[Module] ([ContentID], [CourseName], [Title], [Version], [OrderNumber], [ContactEmail]) VALUES (2, NULL, N'JAVA SQL Connection', 1, 1, N'eduardrozeboom@teleworm.us')
GO
INSERT [dbo].[Module] ([ContentID], [CourseName], [Title], [Version], [OrderNumber], [ContactEmail]) VALUES (4, NULL, N'How to Download more RAM', 4, 20, N'herwinsaalmink@rhyta.com')
GO
INSERT [dbo].[Module] ([ContentID], [CourseName], [Title], [Version], [OrderNumber], [ContactEmail]) VALUES (5, NULL, N'Hello World in Java', 13, 37, N'eduardrozeboom@teleworm.us')
GO
INSERT [dbo].[Module] ([ContentID], [CourseName], [Title], [Version], [OrderNumber], [ContactEmail]) VALUES (7, NULL, N'Intro JavaScript', 2, 5, N'henk@politiekatwijk.com')
GO
INSERT [dbo].[Module] ([ContentID], [CourseName], [Title], [Version], [OrderNumber], [ContactEmail]) VALUES (8, NULL, N'Hello World in Assembly', 6, 242, N'herwinsaalmink@rhyta.com')
GO
INSERT [dbo].[Module] ([ContentID], [CourseName], [Title], [Version], [OrderNumber], [ContactEmail]) VALUES (9, NULL, N'Avans Intake', 42, 5425, N'henk@politiekatwijk.com')
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_CourseRecommendation]    Script Date: 19/12/2021 14:14:22 ******/
...
GO
/****** Object:  Index [IX_Enrollment]    Script Date: 19/12/2021 14:14:22 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [AK_Title_Version]    Script Date: 19/12/2021 14:14:22 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [AK_Title]    Script Date: 19/12/2021 14:14:22 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [AK_URL]    Script Date: 19/12/2021 14:14:22 ******/
...
GO
ALTER TABLE [dbo].[Progress]  WITH CHECK ADD  CONSTRAINT [FK_Progress_Enrollment] FOREIGN KEY([EnrollmentID])
REFERENCES [dbo].[Enrollment] ([ID])
GO
ALTER TABLE [dbo].[Progress] CHECK CONSTRAINT [FK_Progress_Enrollment]
GO
